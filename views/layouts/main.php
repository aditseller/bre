...
<div class="panel panel-default">
<div class="panel-heading">
<h2 class="panel-title"><span class="glyphicon glyphicon-star"></span> Company</h3>
</div>
<div class="panel-body">
<?= Html::a('<span class="glyphicon glyphicon-th-list"></span> List Company',['company/index'],['class'=>'list-group-item list-group-item-primary']) ?>
</div>
</div>
